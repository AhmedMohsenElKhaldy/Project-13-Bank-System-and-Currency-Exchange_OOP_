...
public:
 ...
 static   clsCurrency FindByCode(string CurrencyCode)
 {
     ...
     CurrencyCode = ClsString::ConverAllStringToUpperCase(CurrencyCode);
 ...
 {
     Country = ClsString::ConverAllStringToUpperCase(Country);
     ...
     if (MyFile.is_open())
     {
         ...
         {
             clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
             if (ClsString::ConverAllStringToUpperCase(Currency.Country()) == Country)
             {
                 MyFile.close();
                 return Currency;
             }
